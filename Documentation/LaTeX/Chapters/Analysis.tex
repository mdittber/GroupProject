...
In this chapter we will take a look at the simulation data. The parameters used for the simulation can be found in appendix ~\ref{APPENDIX}. We will make a brief analysis of the energy levels and wave function of PbS QDs and draw some conclusions.\\
...
\begin{figure}
	...
	\caption{Probability density for an energy state in the lower conduction band of an 8nm QD. Locations of very high probability are shown in red, those of medium to high probability in yellow, such that the sum of the probabilities of all yellow and red locations is 50\%.}
