...
%         end
        subplot(2,3,i)
            ...
            hold on;
            for k=1:length(CB_E_0_0)
                plot([0 5], [CB_E_0_0(i) CB_E_0_0(i)],'-g')
            end
            for k=1:length(VB_E_0_0)
...
Qdots(i).mat_name
            ...
            stitle = ['Material: ', Qdots(i).mat_name, ', Radius: ', num2str(Qdots(i).geometry.radius) ,', Voltage: ', num2str(Qdots(i).Vdmax)]
