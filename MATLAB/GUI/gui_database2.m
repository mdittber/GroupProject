function varargout = gui_database2(varargin)
% GUI_DATABASE2 MATLAB code for gui_database2.fig
%      GUI_DATABASE2, by itself, creates a new GUI_DATABASE2 or raises the existing
%      singleton*.
%
%      H = GUI_DATABASE2 returns the handle to a new GUI_DATABASE2 or the handle to
%      the existing singleton*.
%
%      GUI_DATABASE2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_DATABASE2.M with the given input arguments.
%
%      GUI_DATABASE2('Property','Value',...) creates a new GUI_DATABASE2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gui_database2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_database2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help gui_database2

% Last Modified by GUIDE v2.5 09-May-2013 22:21:49

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @gui_database2_OpeningFcn, ...
                   'gui_OutputFcn',  @gui_database2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before gui_database2 is made visible.
function gui_database2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_database2 (see VARARGIN)

% Choose default command line output for gui_database2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes gui_database2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = gui_database2_OutputFcn(hObject, eventdata, handles) 
